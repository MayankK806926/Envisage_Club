...
# Modified for USB webcam and Windows compatibility
#
# Description: Python script to detect and identify playing cards
# from a USB webcam video feed.
...
videostream.set(cv2.CAP_PROP_FRAME_WIDTH, IM_WIDTH)
videostream.set(cv2.CAP_PROP_FRAME_HEIGHT, IM_HEIGHT)
videostream.set(cv2.CAP_PROP_FPS, FRAME_RATE)
